...
In this 3 day workshop we will work with you along with your **OWN data-set** (no toy or dummy data here) to give you a manuscript ready result while you are learning valuable skills in **R** and **statistical analysis**.
...
Tata Medical Center, 14 MAR (E-W), New Town, Action Area III, Rajarhat, West Bengal 700156 https://tmckolkata.com Phone: +91-33-66057400
...
leaflet() %>%
  ...
  addMarkers(lng=88.4796313478333, lat=-22.577130545395814, popup="Tata Medical Center")
```
...
Dr Santam Chakraborty, Senior Consultant, Department of Radiation Oncology, Tata Medical Center, Kolkata, West Bengal, India
