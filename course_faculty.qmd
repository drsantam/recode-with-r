...
::: {style="float:left; position:relative;top:0px;padding:10px;"}
![](images/sougata.jpg){alt="sougata" fig-alt="Image of Mr Sougata Maity" fig-align="left" width="200"}
:::
...
::: {style="float:left; position:relative;top:0px;padding:10px;"}
![](images/oindrilla.png){alt="oindrilla" fig-alt="Image of Ms Oindrilla Roy Chowdhury" fig-align="left" width="200"}
:::

Hi, I am Ms Oindrilla Roy Chowdhury and I will be the faculty for this course. I am a Data Imaging Scientist and currently working actively on India's first image bank - [CHAVI](#0 "CHAVI Homepage"){target="_blank"}. I am actively involved in the statistical analysis of several ongoing research projects at Tata Medical Center and involved in the development of prognostic and predictive models.
